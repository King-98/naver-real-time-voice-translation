...
public class VoiceChatBotActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_voice_chat_bot);
        SharedPreferences sharedPref = getSharedPreferences("PREF", Context.MODE_PRIVATE);

        clientId = sharedPref.getString("application_client_id", "lux1tmil04");
        clientSecret = sharedPref.getString("application_client_secret", "pWH2QvKSy4LLwR852a14bVtMcq6dw96XuzMNhul9");
        ...
        voiceChatbotReplay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TextView txtResult = (TextView) findViewById(R.id.btn_voice_chatbot1);
    ...
    private void requestChatbot() {
        ...
        String chatbotApiGwUrl = sharedPref.getString("chatbot_api_gw_url", "https://8jcr01rdwt.apigw.ntruss.com/custom_api/prod/");
        String chatbotSecretKey = sharedPref.getString("chatbot_secret_key", "cVlJdnNOUW9TVE5pWHpGT3hXTGt4Yk9CbHRyV0FiREs=");
    ...
    public String ReturnThreadResult(String result) {
        ...
        try{
            ...
            for (int i =0; i < bubbles.length(); i++){
                ...
                TextView txtResult = (TextView) findViewById(R.id.textViewVoiceChatbotResult);
