...
public class CssActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String clientId = sharedPref.getString("application_client_id", "lux1tmil04");
        final String clientSecret = sharedPref.getString("application_client_secret", "pWH2QvKSy4LLwR852a14bVtMcq6dw96XuzMNhul9");
