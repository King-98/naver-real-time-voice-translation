...
public class NmtActivity2 extends BaseActivity { // 실질적인부분은 프록시
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nmt2);
        ...
        /************ Papago NMT **************/
        nmtClientId = sharedPref.getString("application_client_id", "lux1tmil04");
        nmtClientSecret = sharedPref.getString("application_client_secret", "pWH2QvKSy4LLwR852a14bVtMcq6dw96XuzMNhul9");
