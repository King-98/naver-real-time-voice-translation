...
public class NmtActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String nmtClientId = sharedPref.getString("application_client_id", "lux1tmil04");
        final String nmtClientSecret = sharedPref.getString("application_client_secret", "pWH2QvKSy4LLwR852a14bVtMcq6dw96XuzMNhul9");
